...
<body>
  ...
  <section class="home-section">
    <div class="container-fluid">
      ...
      <div class="float-end">  
      <select name="keyword_belum" id="keyword_belum" class="float-end w-40 form-select" aria-label="Default select example">
...
var keyword_belum = document.getElementById('keyword_belum');
var container_belum = document.getElementById('container_belum');

keyword_belum.addEventListener('change', function(){
    //membuat objek ajax
    var xhr = new XMLHttpRequest();
    //cek ajax ready
    xhr.onreadystatechange = function(){
        if(xhr.readyState == 4 && xhr.status == 200){
            container_belum.innerHTML = xhr.responseText;
        }
    }
    //eksekusi ajax
    xhr.open('GET', 'getmhsbelumpkl.php?keyword_belum=' + keyword_belum.value, true);
    xhr.send();
});

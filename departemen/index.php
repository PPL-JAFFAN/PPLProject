...
var yValues = [<?php echo mysqli_num_rows($aktif2016); ?>, <?php echo mysqli_num_rows($aktif2017); ?>,
    <?php echo mysqli_num_rows($aktif2018); ?>,
    <?php echo mysqli_num_rows($aktif2019); ?>, <?php echo mysqli_num_rows($aktif2020); ?>,
    <?php echo mysqli_num_rows($aktif2021); ?>, <?php echo mysqli_num_rows($aktif2022); ?>
];
...
<script>
var xValues = ["2016", "2017", "2018", "2019", "2020", "2021", "2022"];
var yValues = [<?php echo mysqli_num_rows($Nonaktif2016); ?>, <?php echo mysqli_num_rows($Nonaktif2017); ?>,
    <?php echo mysqli_num_rows($Nonaktif2018); ?>,
    <?php echo mysqli_num_rows($Nonaktif2019); ?>, <?php echo mysqli_num_rows($Nonaktif2020); ?>,
    <?php echo mysqli_num_rows($Nonaktif2021); ?>, <?php echo mysqli_num_rows($Nonaktif2022); ?>
];
var barColors = ["#8974FF", "#8974FF", "#8974FF", "#8974FF", "#8974FF", "#8974FF", "#8974FF"];
...
<script>
var xValues = ["2016", "2017", "2018", "2019", "2020", "2021", "2022"];
var yValues = [<?php echo mysqli_num_rows($cuti2016); ?>, <?php echo mysqli_num_rows($cuti2017); ?>,
    <?php echo mysqli_num_rows($cuti2018); ?>,
    <?php echo mysqli_num_rows($cuti2019); ?>, <?php echo mysqli_num_rows($cuti2020); ?>,
    <?php echo mysqli_num_rows($cuti2021); ?>, <?php echo mysqli_num_rows($cuti2022); ?>
];
var barColors = ["#8974FF", "#8974FF", "#8974FF", "#8974FF", "#8974FF", "#8974FF", "#8974FF"];
...
<script>
var xValues = ["2016", "2017", "2018", "2019", "2020", "2021", "2022"];
var yValues = [<?php echo mysqli_num_rows($lulus2016); ?>, <?php echo mysqli_num_rows($lulus2017); ?>,
    <?php echo mysqli_num_rows($lulus2018); ?>,
    <?php echo mysqli_num_rows($lulus2019); ?>, <?php echo mysqli_num_rows($lulus2020); ?>,
    <?php echo mysqli_num_rows($lulus2021); ?>, <?php echo mysqli_num_rows($lulus2022); ?>
];
var barColors = ["#8974FF", "#8974FF", "#8974FF", "#8974FF", "#8974FF", "#8974FF", "#8974FF"];
...
<script>
var xValues = ["2016", "2017", "2018", "2019", "2020", "2021", "2022"];
var yValues = [<?php echo mysqli_num_rows($ud2016); ?>, <?php echo mysqli_num_rows($ud2017); ?>,
    <?php echo mysqli_num_rows($ud2018); ?>,
    <?php echo mysqli_num_rows($ud2019); ?>, <?php echo mysqli_num_rows($ud2020); ?>,
    <?php echo mysqli_num_rows($ud2021); ?>, <?php echo mysqli_num_rows($ud2022); ?>
];
var barColors = ["#8974FF", "#8974FF", "#8974FF", "#8974FF", "#8974FF", "#8974FF", "#8974FF"];
...
<script>
var xValues = ["2016", "2017", "2018", "2019", "2020", "2021", "2022"];
var yValues = [<?php echo mysqli_num_rows($do2016); ?>, <?php echo mysqli_num_rows($do2017); ?>,
    <?php echo mysqli_num_rows($do2018); ?>,
    <?php echo mysqli_num_rows($do2019); ?>, <?php echo mysqli_num_rows($do2020); ?>,
    <?php echo mysqli_num_rows($do2021); ?>, <?php echo mysqli_num_rows($do2022); ?>
];
var barColors = ["#8974FF", "#8974FF", "#8974FF", "#8974FF", "#8974FF", "#8974FF", "#8974FF"];

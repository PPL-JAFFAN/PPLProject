        ...
        <section class="home-section">
            <div class="container-fluid">
                ...
                <div class="d-flex justify-content-center" id="searchmhs">
                    <h3>Mahasiswa Perwalian Aktif</h3>
                ...
                <div class="card rounded-4 mt-5">
                    <div class="card-body">
                        ...
                        <table class="mt-3 d-flex justify-content-center" id="tabelmhs">
                            ...
                            <?php
                            $query = "SELECT * FROM tb_mhs WHERE status='Aktif' AND kode_wali=" . $_SESSION['kode_wali'];
                            $connect = mysqli_query($conn, $query);
                            $no = 1;

                            if (isset($_POST['cari_mhs'])) {
                                $nama_mhs = $_POST['nama_mhs'];
                                $query = "SELECT * FROM tb_mhs where nama like '%" . $nama_mhs . "%' AND status='Aktif' AND kode_wali=" . $_SESSION['kode_wali'];
                                $connect = mysqli_query($conn, $query);
                                $no = 1;
                            }

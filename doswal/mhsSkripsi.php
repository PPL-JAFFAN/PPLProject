...
<head>
    ...
    <title>Data Mahasiswa Skripsi</title>
                ...
                <div class="card rounded-4 mt-5">
                    <div class="card-body">
                        ...
                        <table class="mt-3 d-flex justify-content-center" id="tabelmhs">
                            ...
                            <?php
                            $query = "SELECT * FROM tb_mhs JOIN tb_skripsi ON tb_mhs.nim = tb_skripsi.nim WHERE tb_skripsi.status_skripsi='LULUS' AND tb_mhs.kode_wali=" . $_SESSION['kode_wali'];
                            $connect = mysqli_query($conn, $query);
                            $no = 1;

                            if (isset($_POST['cari_mhs'])) {
                                $nama_mhs = $_POST['nama_mhs'];
                                $query = "SELECT * FROM tb_mhs JOIN tb_skripsi ON tb_mhs.nim = tb_skripsi.nim WHERE tb_skripsi.status_skripsi='LULUS' AND tb_mhs.nama like '%" . $nama_mhs . "%' AND tb_mhs.kode_wali=" . $_SESSION['kode_wali'];
                                $connect = mysqli_query($conn, $query);
                                $no = 1;
                            }

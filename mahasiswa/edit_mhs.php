                ...
                <div class="card-body">
                  ...
                  <div class="mx-5">
                    <div class="row">
                      ...
                      <br>
                      <div class="col-sm-11">
                        <input class="form-control mb-2" type="text" name="nama" placeholder="Nama Lengkap" value="<?php echo $mhsDetail['nama']; ?>" />
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <br>
                      <div class="col-sm-11">
                        <span class="form-control mb-2 bg-light" type="text-muted" name="nim" placeholder="Nim"><?php echo $_SESSION['nim']; ?></span>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <br>
                      <div class="col-sm-11">
                        <span class="form-control mb-2 bg-light" type="text-muted" placeholder="Angkatan"><?php echo $mhsDetail['angkatan']; ?></span>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <br>
                      <div class="col-sm-11">
                        <input class="form-control mb-2" type="text" name="email" placeholder="mhs@gmail.com" value="<?php echo $mhsDetail['email']; ?>" />
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <br>
                      <div class="col-sm-11">
                        <input class="form-control mb-2" type="text" name="alamat" placeholder="Alamat" value="<?php echo $mhsDetail['alamat']; ?>" />
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <br>
                      <div class="col-sm-11">
                        <input class="form-control mb-2" type="text" name="telepon" placeholder="No Telephone" value="<?php echo $mhsDetail['no_hp']; ?>" />
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <br>
                      <div class="col-sm-11">
                        <input class="form-control mb-2" type="text" name="password" placeholder="Password" value="<?php echo $mhsPass['password']; ?>" />
                      </div>
                    </div>

                            ...
                            <form action="" method="POST">
                                ...
                                <select name="status" id="status" class="form-select"
                                    ...
                                    <option value="BELUM MENGAMBIL"
                                        <?php if ($skripsiDetail['status_skripsi'] == 'BELUM MENGAMBIL') echo 'selected'; ?>>
                                        BELUM MENGAMBIL</option>
                                    <option value="SEDANG MENGAMBIL"
                                        <?php if ($skripsiDetail['status_skripsi'] == 'ON GOING') echo 'selected'; ?>>ON
                                        GOING</option>
                                    <option value="LULUS"
                                        <?php if ($skripsiDetail['status_skripsi'] == 'LULUS') echo 'selected'; ?>>LULUS
                                    </option>
                                </select>
                                </br>
                                ...
                                <label for="tanggal_sidang" class="tanggal_sidang"
                                    aria-label="Default select example">Tanggal Sidang</label>
                                <input type="date" name="tanggal_sidang" id="tanggal_sidang" class="form-control"
                                    value="<?php echo $skripsiDetail['tanggal_sidang']; ?>">
                                </br>
                                <label for="dosbing" class="form-label">Dosen Pembimbing</label>
                                <select name="dosbing" id="dosbing" class="form-select"

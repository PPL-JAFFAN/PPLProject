...
if (isset($_POST['submit'])) {
    ...
    document.location.href = 'mhs_khs.php';
    </script>";
    } else {
        echo "<script>
...
<body>
        ...
        <ul class="nav-list">
            ...
            <li class="profile">
                <div class="profile-details">
                    ...
                    <div class="name_job">
                        <div style="color: hsl(218, 81%, 75%)"  ><?php echo $mhsDetail['nama']; ?></div>
                        <div class="text-light"><?php echo $mhsDetail['email']; ?></div>
                    </div>
                </div>
    ...
    <section class="home-section">
        ...
        <div class="mx-5">
            ...
            <div class="d-flex justify-content-center">
                <?php
                if ($khsDetail['file_khs']) {
                    echo "File terupload : " . $khsDetail['file_khs'];
                } else {
            ...
            <!-- <div class="d-flex justify-content-center">
            <button type="button" id="btn_upload" class="btn btn-primary mt-3 "><span class="glyphicon glyphicon-arrow-up"></span>Submit</button>
        </div> -->
        </div>
    </section>

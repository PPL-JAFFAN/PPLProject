    ...
    <div class="text">
      ...
      <div>
        ...
        <div>
          ...
          <div><?= $dosenwaliDetail['nama'] ?></div>
          <div>Status Skripsi</div>
          <div><?php echo $skripsiDetail['status_skripsi']; ?></div>
          <div>Nilai</div>
          <div><?php echo $skripsiDetail['nilai_skripsi']; ?></div>
          <div>Laporan Progres PKL</div>
          <div><?php echo $skripsiDetail['scan_skripsi']; ?></div>

<?php
  ...
  $keyword_belum = $_GET["keyword_belum"];
...
<body>
      <table id="example" class="table   rounded-3" style="width:100%">
        ...
        <tbody>
          <?php
          $ambildata = mysqli_query($conn, "SELECT * FROM tb_mhs m, tb_pkl p WHERE  m.nim = p.nim  AND m.angkatan LIKE '%$keyword_belum%' AND status_pkl = 'BELUM MENGAMBIL'"  );
          $i = 1;

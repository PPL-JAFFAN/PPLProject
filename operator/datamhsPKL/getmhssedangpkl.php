<?php
  ...
  $keyword_sedang = $_GET["keyword_sedang"];
...
<body>
      <table id="example" class="table   rounded-3" style="width:100%">
        ...
        <tbody>
          <?php
          $ambildata = mysqli_query($conn, "SELECT * FROM tb_mhs m, tb_pkl p WHERE  m.nim = p.nim  AND m.angkatan LIKE '%$keyword_sedang%' AND status_pkl = 'SEDANG MENGAMBIL'"  );
          $i = 1;

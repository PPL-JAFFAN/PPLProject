  ...
  <section class="home-section">
    <div class="container-fluid">
      ...
      <table id="example" class="table   rounded-3" style="width:100%">
        ...
        <tbody>
          <?php
          $ambildata = mysqli_query($conn, 'SELECT * FROM tb_mhs m, tb_skripsi p WHERE  m.nim = p.nim AND p.status_skripsi = "LULUS"'  );
          $i = 1;
...
keyword.addEventListener('change', function(){
    ...
    //eksekusi ajax
    xhr.open('GET', 'getmhsskripsi.php?keyword=' + keyword.value, true);
    xhr.send();
});

...
<body>
  ...
  <section class="home-section">
    <div class="container-fluid">
      ...
      <a class="btn btn-primary dropdown-toggle" href="datamhsnonaktif.php" role="button" data-bs-toggle="dropdown" aria-expanded="false">
        Angkatan
      </a>

      <ul class="dropdown-menu">
        <li><a class="dropdown-item" href="datamhsnonaktif.php">Semua</a></li>
        <li><a class="dropdown-item" href="./datamhs/nonaktif/2016.php">2016</a></li>
        <li><a class="dropdown-item" href="./datamhs/nonaktif/2017.php">2017</a></li>
        <li><a class="dropdown-item" href="./datamhs/nonaktif/2018.php">2018</a></li>
        <li><a class="dropdown-item" href="./datamhs/nonaktif/2019.php">2019</a></li>
        <li><a class="dropdown-item" href="./datamhs/nonaktif/2020.php">2020</a></li>
        <li><a class="dropdown-item" href="./datamhs/nonaktif/2021.php">2021</a></li>
        <li><a class="dropdown-item" href="./datamhs/nonaktif/2022.php">2022</a></li>
      ...
      <table id="example" class="table   rounded-3" style="width:100%">
        ...
        <tbody>
          <?php
          $ambildata = mysqli_query($conn, 'SELECT * FROM tb_mhs WHERE status = "Nonaktif" ORDER BY  nama ASC, semester ASC'  );
          $i = 1;
          while ($data = mysqli_fetch_array($ambildata)) {
              $nim = $data['nim'];
              $nama = $data['nama'];

        ...
        <div class="card p-4 rounded-4">
          ...
          ?>
                    ...
                    <tr>
                        ...
                        <!-- <td><?= $no_hp; ?></td> -->
                        <td>
                            <button type="submit" class="btn btn-primary" data-bs-dismiss="modal" name="edit_mhs"
                                data-bs-toggle="modal" data-bs-target="#edit_mhs<?= $nim; ?>">Edit</button>
                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal" name="delete_mhs"
                                data-bs-toggle="modal" data-bs-target="#delete_mhs<?= $nim; ?>">Hapus</button>
                        </td>
                    </tr>
                ...
                <br> -->
                                        <input type="text" name="semester" placeholder="Semester"
                                            value="<?= $semester; ?>" class="form-control" required>
                                        <br>
...
<div class="modal fade" id="add_mhs">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- Modal body -->
            <form method="POST" action="manajemenakun.php">
                <div class="modal-body">

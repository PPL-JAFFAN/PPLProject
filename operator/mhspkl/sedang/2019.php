...
<body>
  ...
  <section class="home-section">
    <div class="container-fluid">
      ...
      <?php
          $ambildata = mysqli_query($conn, "SELECT * FROM tb_mhs m, tb_pkl p WHERE  m.nim = p.nim AND status_pkl = 'LULUS' AND angkatan = '2019'");
          $lulus = 0;
          while ($data = mysqli_fetch_array($ambildata)) {
              $lulus++;
              }

          $ambildata = mysqli_query($conn, "SELECT * FROM tb_mhs m, tb_pkl p WHERE  m.nim = p.nim AND status_pkl = 'BELUM MENGAMBIL' AND angkatan = '2019'");
          $belum = 0;
          while ($data = mysqli_fetch_array($ambildata)) {
              $belum++;
              }

          $ambildata = mysqli_query($conn,"SELECT * FROM tb_mhs m, tb_pkl p WHERE  m.nim = p.nim AND status_pkl = 'SEDANG MENGAMBIL' AND angkatan = '2019'");
          $sedang = 0;
          while ($data = mysqli_fetch_array($ambildata)) {
              $sedang++;
              }

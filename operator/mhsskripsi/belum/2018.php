...
<body>
  ...
  <section class="home-section">
    <div class="container-fluid">
      ...
      <a class="btn btn-primary dropdown-toggle" href="../../mhsbelumskripsi.php" role="button" data-bs-toggle="dropdown" aria-expanded="false">
        2018
      </a>
      ...
      <?php
          $ambildata = mysqli_query($conn, "SELECT * FROM tb_mhs m, tb_skripsi p WHERE  m.nim = p.nim AND verif_skripsi = 'sudah' AND angkatan ='2018'");
          $sudah = 0;
          while ($data = mysqli_fetch_array($ambildata)) {
              $sudah++;
              }

          $ambildata = mysqli_query($conn, "SELECT * FROM tb_mhs m, tb_skripsi p WHERE  m.nim = p.nim AND verif_skripsi = 'belum' AND angkatan ='2018'");
          $belum = 0;
          while ($data = mysqli_fetch_array($ambildata)) {
              $belum++;
              }

...
<body>
  ...
  <section class="home-section">
    <div class="container-fluid">
      ...
      <?php
          $ambildata = mysqli_query($conn, "SELECT * FROM tb_mhs m, tb_skripsi p WHERE  m.nim = p.nim AND verif_skripsi = 'sudah' AND angkatan ='2022'");
          $sudah = 0;
          while ($data = mysqli_fetch_array($ambildata)) {
              $sudah++;
              }

          $ambildata = mysqli_query($conn, "SELECT * FROM tb_mhs m, tb_skripsi p WHERE  m.nim = p.nim AND verif_skripsi = 'belum' AND angkatan ='2022'");
          $belum = 0;
          while ($data = mysqli_fetch_array($ambildata)) {
              $belum++;
              }

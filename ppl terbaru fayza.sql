...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 10, 2022 at 02:40 PM
...
('1', 'Drs. Eko Adi Sarwoko, M.Kom.', '196511071992031003', 'Jalan Mawar Berduri No. 309', 'ekoadis@gmail.com', '081345234567', 827),
...
('2406012012048', 'Aurora Laksmiwati', 'Jr. Ketandan No. 436', 784, '2019', 'SNMPTN', 'cici.nasyidah@utami.or.id', '088685980865', 'Cuti', '', '3', '7'),
...
('240601201239', 'Baktiadi Saptono', 'Dk. Banda No. 546', 1104, '2018', 'SNMPTN', 'oni26@yahoo.co.id', '083086943677', 'Lulus', '', '5', '8'),
('2406012012615', 'Bella Riyanti', 'Gg. Karel S. Tubun No. 315', 830, '2022', 'SBMPTN', 'gilda10@winarno.co.id', '089670494174', 'Aktif', '', '5', '1'),
('240601201293', 'Irsad Setiawan', 'Ds. Kyai Mojo No. 278', 633, '2019', 'SBMPTN', 'melani.paris@yahoo.com', '084925924122', 'Aktif', '', '5', '7'),
...
('2406012018', 'Anita Sudiati', 'Jalan. Taman No. 134', 634, '2019', 'SNMPTN', 'outama@yahoo.co.id', '080660996714', 'Cuti', '', '5', '7'),
...
('196511071992031003', 'Drs. Eko Adi Sarwoko, M.Kom.', 'dosen', '1234', 'ekoadis@gmail.com'),
...
--
ALTER TABLE `tb_khs`
  MODIFY `id_khs` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `tb_mhs`
  ADD CONSTRAINT `kode_kota` FOREIGN KEY (`kode_kota`) REFERENCES `tb_kota` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
